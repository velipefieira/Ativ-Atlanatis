    ...
    if (clienteSelecionado) {
        ...
        return (
            <Modal show={props.show} onHide={props.handleClose}>
                ...
                <Modal.Body>
                    {props.show && clienteSelecionado &&(
                        <>
                            <p><strong>Nome:</strong> {clienteSelecionado.nome}</p> <hr />
                            <p><strong>Nome social:</strong> {clienteSelecionado.nomeSocial}</p> <hr />
                            <p><strong>Data Nascimento:</strong> {clienteSelecionado.dataNascimento}</p> <hr />
                            <p><strong>Data Cadastro:</strong> {clienteSelecionado.dataCadastro}</p> <hr />
                            ...
                            <p><strong> Documentos: </strong></p> {clienteSelecionado.documentos.map(doc => (
                                <div key={doc.numero}>
                                    <p> {doc.tipo} </p>
                                    <p>{doc.numero} - Emitido em: {doc.dataExpedicao} </p> <hr />
                                </div>
                            ))}
                                ...
                                <>
                                    ...
                                    {clienteSelecionado.dependentes.map(dep => (
                                        <div key={dep.id}>
                                            ...
                                            <p><strong> Nome Social: </strong>{dep.nomeSocial}</p> <hr />
                                        </div>
                                        ))}
                                </>
                            )}
                            {clienteSelecionado.titular !== null && clienteSelecionado.titular !== undefined &&(
                                <div>
